...
public class ItemInit {
    ...
    public static final RegistryObject<Item> UPGRADED_NETHERITE_INGOT = register("upgraded_netherite_ingot", () -> new Item(new Item.Properties().tab(Main.RANDOMTHINGS_ORE_TAB)));
    ...
    public static final RegistryObject<SwordItem> UPGRADED_NETHERITE_SWORD = register("upgraded_netherite_sword", () -> new SwordItem(ItemMaterialInit.UPGRADED_NETHERITE, 3, 1.2f, new Item.Properties().tab(Main.RANDOMTHINGS_TOOL_AND_ARMOR_TAB)));
    public static final RegistryObject<PickaxeItem> UPGRADED_NETHERITE_PICKAXE = register("upgraded_netherite_pickaxe", () -> new PickaxeItem(ItemMaterialInit.UPGRADED_NETHERITE, 2, 1.2f, new Item.Properties().tab(Main.RANDOMTHINGS_TOOL_AND_ARMOR_TAB)));
    public static final RegistryObject<AxeItem> UPGRADED_NETHERITE_AXE = register("upgraded_netherite_axe", () -> new AxeItem(ItemMaterialInit.UPGRADED_NETHERITE, 5, 1.2f, new Item.Properties().tab(Main.RANDOMTHINGS_TOOL_AND_ARMOR_TAB)));
    public static final RegistryObject<HoeItem> UPGRADED_NETHERITE_HOE = register("upgraded_netherite_hoe", () -> new HoeItem(ItemMaterialInit.UPGRADED_NETHERITE, 2, 1f, new Item.Properties().tab(Main.RANDOMTHINGS_TOOL_AND_ARMOR_TAB)));
    public static final RegistryObject<ShovelItem> UPGRADED_NETHERITE_SHOVEL = register("upgraded_netherite_shovel", () -> new ShovelItem(ItemMaterialInit.UPGRADED_NETHERITE, 2, 1f, new Item.Properties().tab(Main.RANDOMTHINGS_TOOL_AND_ARMOR_TAB)));
